...
# 文件路径配置
ex_file = "D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.4/Ex"  # Ex 数据文件路径
amp0_file = "D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.4/Amp0"  # Amp0 数据文件路径
amp1_file = "D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.4/Amp1"  # Amp1 数据文件路径
amp2_file = "D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.4/Amp2"  # Amp2 数据文件路径

# 启动 C 程序（替换为你的 C 程序路径）
c_program = "D:/HKZ_Coding/FDTD_Learning/FDTD_2.4 Plasma.exe"  # 替换为你的 C 程序可执行文件路径
