...
int main ()
{
    ...
    while (nsteps > 0) {
        ...
        fp = fopen("D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.2/Ex","w");
        for (k=0; k < KE; k++) {
            fprintf(fp, " %2d %6.3f \n", k, ex[k]);
        }
        fclose(fp);
        ...
        for (m=0; m <= 2; m++) {
            ...
            fp = fopen("D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.2/Amp0","w");
            for (k=0; k < KE; k++) {
                fprintf(fp, " %2d %8.5f \n", k, ampn[0][k]);
            }
            fclose(fp);

            fp = fopen("D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.2/Amp1","w");
            for (k=0; k < KE; k++) {
                fprintf(fp, " %2d %8.5f \n", k, ampn[1][k]);
            }
            fclose(fp);

            fp = fopen("D:/HKZ_Coding/FDTD_Learning/Ouput/FDTD_2.2/Amp2","w");
            for (k=0; k < KE; k++) {
                fprintf(fp, " %2d %8.5f \n", k, ampn[2][k]);
            }
            fclose(fp);
